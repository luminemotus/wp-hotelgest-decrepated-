                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body-book row">
                            ...
                            <div class="panel-group col-xs-12 col-sm-6" id="checkoutbook">
                                 <!-- bloq extras and customer -->
                                <div class="panel extrasPanel">
                                ...
                                <!-- fin bloq extras and customer -->
                                <!-- bloq confirm booking --> 
                                <div class="panel customerdetailsPanel">
                                    <div class="panel-heading">
                                        <h3>
                                    ...
                                    <div id="customerdetails" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-4 form-group">
                                                    <input value=""  id="booking-arrival-hour" placeholder="Arrival time" type="text" class="form-control customer-arrival-time" name="customer-arrival-time" >
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div id="noPayment" style="display: none">
                                                    <div class="card-wrapper col-xs-12 col-sm-5 hidden-xs" style="transform: scale(0.9);display:none"></div>
                                                    ...
                                                    <?php // <div  class="alert alert-success" > <span class="trn">NO PREPAYMENT NEEDED</span> - <small class="trn">pay at the property</small> </div>  ?>
                                                </div>
                                                <div id="tpvPayment" class="alert alert-success" style="display: none">
                                                    <span class="trn">You will be redirected to the payment gateway. The total amount to pay to confirm this booking is:</span>
                                                    <span class="price"> </span>
                                ...
                                <!-- fin bloq confirm booking -->
                                
                                <!-- bloq payment -->
                                <div class="panel paymentPanel" style="display:none">
                                    <div class="panel-heading">
                                        <h3>
                                            <a  id="btn-paymentContainer" data-toggle="collapse" data-parent="#checkoutbook" href="#paymentContainer">
                                                 <span class="trn">Payment</span> <i class="fa fa-angle-down rotate-icon"></i>
                                            </a>
                                        </h3>
                                    </div>
                                    <div id="paymentContainer" class="panel-collapse collapse">
                                        <div id="page-load-mask" class="am-fade hide" >
                                            <div class="load-content">
                                                <i class="fa fa-spinner fa-pulse"></i>
                                                <h1 class="trn">validating</h1>
                                            </div>
                                        </div>
                                        <div class="panel-body">
                                            <iframe sandbox="allow-forms allow-popups allow-popups allow-same-origin allow-scripts " id="paycometIframe"  width="400" height="525" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" style="border: 0px solid #000000; padding: 0px; margin: 0px"></iframe>                                        </div>
                                    </div>
                                </div>
                                <!-- fin bloq extras and customer -->
